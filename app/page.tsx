...
import image5 from "../public/food-app.png"
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      >
        <CardContent>
          <Image src={image5} alt="food-app" className="rounded-lg mb-4 w-full h-auto" />
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-medium">QR-based Self Ordering System</h3>
...
>
  ...
  <p className="text-gray-500">© 2026 Naman Chaturvedi</p>
</main>
        </div>
        </div>
  );
